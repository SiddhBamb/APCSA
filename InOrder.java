public class InOrder
{
	...
	public boolean sort()
	{
		if((numOne <= numTwo) && (numTwo <= numThree) )
		{
			System.out.println("The sorted numbers are: " + numOne + " <= " + numTwo + " <= " + numThree + ".");
			numOne = numOne;
			numTwo = numTwo;
			numThree = numThree;
			return true;
		...
		{
			System.out.println("The sorted numbers are: " + numThree + " <= " + numTwo + " <= " + numOne + ".");
			tempOne = numOne;
			tempTwo = tempTwo;
			tempThree = tempThree;
			numOne = numThree;
		...
		{
			System.out.println("The sorted numbers are: " + numTwo + " <= " + numOne + " <= " + numThree + ".");
			tempOne = numOne;
			tempTwo = tempTwo;
			tempThree = tempThree;
			numOne = numTwo;
		...
		{
			System.out.println("The sorted numbers are: " + numTwo + " <= " + numThree + " <= " + numOne + ".");
			tempOne = numOne;
			tempTwo = tempTwo;
			tempThree = tempThree;
			numOne = numTwo;
		...
		{
			System.out.println("The sorted numbers are: " + numThree + " <= " + numOne + " <= " + numTwo + ".");
			tempOne = numOne;
			tempTwo = tempTwo;
			tempThree = tempThree;
			numOne = numThree;
