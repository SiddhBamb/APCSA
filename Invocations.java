//	purpose:	rudimentary	testing of Invoke	methods
	...
	{	  
      System.out.println( "\nTrying piggyBank() \n"	);
		...
		//	****** uncomment next four	lines	after	completing mp3Sizer()
		 int g1 = Invoke.mp4Sizer( s1, m1, j1 );
		 int g2 = Invoke.mp4Sizer( s2, m2, j2 );

		 System.out.println( "Invoke.mp4Sizer( " + s1 + ", " + m1 + ", " + j1 + "	):	" + g1 );
		 System.out.println( "Invoke.mp4Sizer( " + s2 + ", " + m2 + ", " + j2 + "	):	" + g2 );
	}
}
